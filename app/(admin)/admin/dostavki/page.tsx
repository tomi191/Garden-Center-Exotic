    ...
    <div className="space-y-4 p-3 sm:p-0">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <Link href="/admin/dostavki/nova">
          <Button
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white min-h-[36px] px-3 text-xs rounded-xl"
          >
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <Link href="/admin/dostavki/nova">
            <Button className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white min-h-[36px] px-4 text-xs rounded-xl mx-auto">
              <Plus className="w-5 h-5" />
              {"\u041D\u043E\u0432\u043E \u0437\u0430\u0440\u0435\u0436\u0434\u0430\u043D\u0435"}
            </Button>
          </Link>
