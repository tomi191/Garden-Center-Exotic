...
const prompt = `Generate a stunning professional photograph of premium garden shrubs and trees for a garden center hero section.
Show a beautiful outdoor nursery display with:
- Elegant evergreen thuja (arborvitae) trees in rows
- Decorative boxwood shrubs perfectly shaped
- Flowering hydrangeas with blue and pink blooms
- Japanese maple with red leaves
- Cypress and juniper varieties
- Young fruit trees (apple, cherry)

Style:
- Outdoor garden center nursery setting
- Golden hour natural sunlight
- Rich variety of greens, from dark evergreens to bright chartreuse
- Plants in large nursery containers ready for planting
- Professional commercial photography style
- Premium European garden center aesthetic
- No text, watermarks, or people visible
- Landscape orientation, suitable for website hero section
- Conveys quality, variety, and professional landscaping potential`;
